...
class JoyMappingUpdateRequest(BaseModel):
    ...
    /opt/physicar/joy_mapping.json so it survives reboots.
    """
    ...
    save: bool = Field(default=False, description="Persist to /opt/physicar/joy_mapping.json")
...
async def reset_joy_mapping():
    ...
    The teleop node loads /opt/physicar/joy_mapping.json at startup; if
