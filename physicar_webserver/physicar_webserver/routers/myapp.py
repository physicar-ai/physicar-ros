...
``physicar-myapp.service`` runs ``/home/physicar/physicar_ws/myapp.sh``.
This router writes myapp.sh / myapp.log under
``/home/physicar/physicar_ws/`` and uses ``sudo systemctl`` to control the
...
SCRIPT_FILE = Path("/home/physicar/physicar_ws/myapp.sh")
LOG_FILE = Path("/home/physicar/physicar_ws/myapp.log")
