...
inline const std::string MODELS_BASE_PATH = "/home/physicar/physicar_ws/deepracer/models";

// Config file (JSON, 1st priority)
inline const std::string CONFIG_FILE_PATH = "/home/physicar/physicar_ws/deepracer/config.json";
